...
TableTools.BUTTONS = {
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h6>Pré-visualização de impressão</h6><p>Por favor tecle CTRL+P"+
		  "quando quiser iniciar a impressão. Pressione ESCAPE para voltar.</p>",
		"sMessage": null,
		"bShowAll": true,
		"sToolTip": "Pré-visualizar impressão",
